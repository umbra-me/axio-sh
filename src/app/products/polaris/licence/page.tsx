...
export default function PolarisLicencePage() {
  return <LegalPage title="Polaris personal licence" current="/products/polaris/licence"
    ...
    <h2>Price and use</h2>
    <p>The personal licence is A$59 once, inclusive of applicable tax, with no subscription. Stripe may present a converted local-currency price; review the final total before paying. Purchase grants you perpetual personal use of the supplied application on up to two activated Macs at a time. Deactivate an old Mac in Settings → Licence to move its activation.</p>
